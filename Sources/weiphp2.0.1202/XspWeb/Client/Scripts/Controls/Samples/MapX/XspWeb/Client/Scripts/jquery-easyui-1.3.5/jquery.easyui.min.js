...
return win;
},prompt:function(_27d,msg,fn,value){
var _27e="<div class=\"messager-icon messager-question\"></div>"+"<div>"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\" value=\""+value+"\"/></div>";
var _27f={};
...
function _removeChildren(_739, _73a) {
...
},removeChildren:function(jq,id){
return jq.each(function(){
_removeChildren(this, id);
});
},pop:function(jq,id){
