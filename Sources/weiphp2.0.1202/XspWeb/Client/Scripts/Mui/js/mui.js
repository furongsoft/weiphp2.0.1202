    ...
    var Slider = $.Scroll.extend({
        ...
        _initEvent: function () {
            ...
            self.wrapper.addEventListener('slide', function (e) {
                ...
                //ALEX[[[
                // 添加当前页面变化事件
                if (typeof(self.wrapper["OnPageChanged"]) === "function")
                    self.wrapper["OnPageChanged"].call(null, _slideNumber);
                //]]]ALEX
                e.stopPropagation();
            });
...
(function ($, window, document, name) {
    ...
    var setStyle = function (popover, display, top, left) {
        ...
        if (typeof top !== 'undefined')
            ...
            style.top = (window.innerHeight/2 + document.body.scrollTop) + 'px';
        if (typeof left !== 'undefined')
            style.left = left + 'px';
        else
            style.left = (window.innerWidth/2 - popover.offsetWidth/2) + 'px';
        // ]]]chenfuqian
    };
    var calPosition = function (popover, anchor, isActionSheet) {
        ...
        if (position === 'top' || position === 'bottom') {
            ...
            // chenfuqian[[[ pLeft =   aWidth / 2 + offset.left - pWidth / 2 ; 弹出框总是居于屏幕正中间，不是针对下拉框宽度中间
            pLeft = Math.abs(wWidth / 2 - pWidth / 2);
            ...
            if (arrow) {
                ...
                // chenfuqian[[[
                arrow.classList.remove(CLASS_BOTTOM);
                arrow.classList.remove(CLASS_POPOVER_ARROW);
                // ]]]chenfuqian
            }
...
(function ($, window, document) {
    ...
    Input.prototype.clearActionClick = function (event) {
        ...
        //ALEX[[[
        // 添加清除文本内容事件
        if (typeof(self.element["OnClear"]) === "function")
            self.element["OnClear"].call(self.element);
        //]]]ALEX
        event.preventDefault();
    };
